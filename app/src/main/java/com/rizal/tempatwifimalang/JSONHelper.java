...
public class JSONHelper
{
    ...
    public ArrayList<TempatWifi> getTempatMakanAll(JSONObject jobj)
    {
        ArrayList<TempatWifi> listTempatWifi = new ArrayList<TempatWifi>();
        ...
        try
        {
            ...
            for (int i = 0; i < arrayTempatMakan.length(); i++)
            {
                ...
                listTempatWifi.add(new TempatWifi(jobject.getInt(TAG_ID), jobject.getString(TAG_NAMA), jobject
